               ...
               <div class="col-md-10">
                  <div class="card card-transparent auth-card shadow-none d-flex justify-content-center mb-0">
                     <div class="card-body">
                        ...
                        <h2 class="mb-2 text-center">Connexion pour étudiant</h2>
                        <p class="text-center">connectez-vous à votre compte {{env('APP_NAME')}} .</p>
                        <x-auth-session-status class="mb-4" :status="session('status')" />

                        <!-- Validation Errors -->
                        <x-auth-validation-errors class="mb-4" :errors="$errors" />
                        <form method="POST" action="{{route('userlogin')}}" data-toggle="validator">
                            {{csrf_field()}}
                           <div class="row">
                              {{-- <div class="col-lg-6">
                              ...
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    <label for="phone" class="form-label">CIN : <span class="text-danger">*</span></label> 
                                    <input class="form-control" type="text" name="CIN" placeholder="AB12345">
                                 </div>
                              </div>
                              <div class="col-lg-6">
                                 <div class="form-group">
                                       <label for="phone" class="form-label">Email : <span class="text-danger">*</span></label>
                                       <input class="form-control" type="email" placeholder="user@ensa.com" id="email"  name="email" value="{{old('email')}}" required>
                                 </div>
                              </div>
                              <div class="col-lg-6">
                                 <div class="form-group">
                                    <label for="phone" class="form-label">Code Apogée : <span class="text-danger">*</span></label> 
                                    <input class="form-control" type="number" name="pin_code" placeholder="12345678">
                                 </div>
                              </div>
                              {{-- <div class="col-lg-6">
                                 <div class="form-group">
                           ...
                           <p class="mt-3 text-center">
                              êtes-vous un admin ? <a href="{{route('auth.signin')}}" class="text-underline">Cliquez ici pour vous connecter. </a>
                           </p>
                        </form>
                     </div>
                  </div> 
