               ...
               <div class="col-md-10">
                  <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                     <div class="card-body">
                        ...
                        <h2 class="mb-2 text-center">Connexion pour admin</h2>
                        <p class="text-center">Connectez-vous pour rester connecté.</p>
                        ...
                        <form method="POST" action="{{ route('login') }}" data-toggle="validator">
                           ...
                           <div class="row">
                              <div class="col-lg-12">
                                 <div class="form-group">
                                    ...
                                    <input id="email" type="email" name="email"  value="{{env('IS_DEMO') ? 'admin@system.com' : old('email')}}"   class="form-control"  placeholder="admin@system.com" required autofocus>
                                 </div>
                              </div>
                              <div class="col-lg-12">
                                 <div class="form-group">
                              ...
                              <div class="col-lg-6">
                                 <div class="form-check mb-3">
                                    ...
                                    <label class="form-check-label" for="customCheck1">Souviens-toi de moi</label>
                                 </div>
                              </div>
                              {{-- <div class="col-lg-6">
                           ...
                           <p class="mt-3 text-center">
                              êtes-vous un étudiant ? <a href="{{route('userlogin')}}" class="text-underline">Cliquez ici pour vous connecter.</a>
                           </p>
                        </form>
                     </div>
                  </div>
