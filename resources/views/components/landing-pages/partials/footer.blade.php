                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <p class="ms-4 mb-0 text-white">ENSA de Avenue de la Palestine Mhanech I, Tétouan, Morocco</p>
                        </div>
                        <div class="d-flex align-items-center">
                            ...
                            <p class="ms-4 mb-0 text-white">(+212) 000-0000</p>
                        </div>
                    </div>
        ...
        <div class="container border-top  py-4 border-primary">
            <div class="row">
                <div class="col-md-12 text-center text-white">
                        <p class="mb-0">©
                            <script>document.write(new Date().getFullYear())</script> EnsaTe, All Rights Reserved.
                        </p>
                    </div>
            </div>
        </div>
