    ...
    <div class="container-fluid navbar-inner">
        ...
        <div class="offcanvas-lg offcanvas-end header-one" tabindex="-1" id="offcanvasResponsive" aria-labelledby="offcanvasResponsiveLabel">
            <ul class=" navbar-nav iq-nav-menu list-unstyled">
                <li class="nav-item">
                    ...
                    <ul class="iq-header-sub-menu list-unstyled collapse" id="homeData">
                       <li class="nav-item"><a class="nav-link {{activeRoute(route('dashboard'))}}" href="{{route('dashboard')}}">login for student</a></li>
                       <li class="nav-item"><a class="nav-link {{activeRoute(route('dashboard'))}}" href="{{route('dashboard')}}">Login for admin</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item"><a class="nav-link {{activeRoute(route('docs'))}}" href="{{route('docs')}}">Pricing</a></li> --}}
            </ul>
            ...
            <ul class=" navbar-nav ">
                ...
                <li class="nav-item"><a class="nav-link {{ activeRoute(route('userlogin')) }}" href="{{ route('userlogin') }}">Espace étudiant</a></li>
            <li class="nav-item"><a class="nav-link {{ activeRoute(route('dashboard')) }}" href="{{ route('dashboard') }}">Espace administrateur</a></li>
