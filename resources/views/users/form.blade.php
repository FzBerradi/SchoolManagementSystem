      ...
      <div class="row">
            ...
            <div class="card">
               <div class="card-header d-flex justify-content-between">
                  <div class="header-title">
                     <h4 class="card-title">{{$id !== null ? 'modifier' : 'ajouter' }} modifier</h4>
                  </div>
               </div>
               <div class="card-body">
         ...
         <div class="col-xl-9 col-lg-8">
            <div class="card">
               <div class="card-header d-flex justify-content-between">
                  <div class="header-title">
                     <h4 class="card-title">{{$id !== null ? 'modifier' : 'ajouter' }}étudiant informations</h4>
                  </div>
                  ...
                  <div class="new-user-info">
                        <div class="row">
                           <div class="form-group col-md-6">
                              ...
                              {{ Form::text('first_name', old('first_name'), ['class' => 'form-control', 'placeholder' => 'Prénom', 'required']) }}
                           </div>
                           <div class="form-group col-md-6">
                              <label class="form-label" for="lname">nom : <span class="text-danger">*</span></label>
                              {{ Form::text('last_name', old('last_name'), ['class' => 'form-control', 'placeholder' => 'nom' ,'required']) }}
                           </div>
                           <div class="form-group col-md-6">
                              <label class="form-label" for="add1">Adresse :</label> <span class="text-danger">*</span></label>
                              {{ Form::text('userProfile[street_addr_1]', old('userProfile[street_addr_1]'), ['class' => 'form-control', 'id' => 'add1', 'placeholder' => 'Adresse' ,'required']) }}
                           </div>
                           {{-- <div class="form-group col-md-6">
                           ...
                           <div class="form-group col-md-6">
                              <label class="form-label" for="mobno">Numéro:</label> <span class="text-danger">*</span></label>
                              {{ Form::text('userProfile[phone_number]', old('userProfile[phone_number]'), ['class' => 'form-control', 'id' => 'mobno', 'placeholder' => 'Numéro', 'required']) }}
                           </div>
                           {{-- <div class="form-group col-md-6">
                           ...
                           <div class="form-group col-md-6">
                              <label class="form-label" for="pno"> Code Apogée : <span class="text-danger">*</span></label>
                              {{ Form::number('userProfile[pin_code]', old('userProfile[pin_code]'), ['class' => 'form-control', 'placeholder' => 'Code Apogée',  'id' => 'pin_code','step' => 'any' ,'required']) }}
                           </div>
                           <div class="form-group col-md-6">
                              <label class="form-label" for="pno">CIN: </label> <span class="text-danger">*</span></label>
                              {{ Form::text('userProfile[CIN]', old('userProfile[CIN]'), ['class' => 'form-control', 'placeholder' => 'CIN',  'id' => 'CIN','step' => 'any', 'required']) }}
                           </div>
                           {{-- <div class="form-group col-md-12">
                        ...
                        <button type="submit" class="btn btn-primary">{{$id !== null ? 'modifier' : 'ajouter' }}  étudiant</button>
                  </div>
               </div>
            </div>
         </div>
