...
class UserController extends Controller
{
    ...
    {
        $pageTitle = "La liste des étudiants";
        $auth_user = AuthHelper::authSession();
        $assets = ['data-table'];
        $headerAction = '<a href="'.route('users.create').'" class="btn btn-sm btn-primary" role="button">ajouter étudiants</a>';
    ...
    public function store(UserRequest $request)
    {
        ...
        return redirect()->route('users.index')->withSuccess("étudiants été ajouté avec succès");
    }
